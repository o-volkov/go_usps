...
// MerchandiseReturnLabel is Base64 encoded file.
// Decode it before use:
// dec, err := base64.StdEncoding.DecodeString(result.MerchandiseReturnLabel)
type EMRSV40BulkResponse struct {
	MerchandiseReturnLabel string `xml:"MerchandiseReturnLabel,omitempty"`
}
